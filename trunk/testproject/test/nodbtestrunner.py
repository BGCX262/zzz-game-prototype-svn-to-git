# Copy of DjangoTestRunner class
# Interaction with DB removed
# DocTest removed (it uses DB settings too)
...
class NoDbDjangoTestRunner(unittest.TextTestRunner):

    def __init__(self, verbosity=0, failfast=False, **kwargs):
        super(NoDbDjangoTestRunner, self).__init__(verbosity=verbosity, **kwargs)
    ...
    def run(self, *args, **kwargs):
        ...
        try:
            result = super(NoDbDjangoTestRunner, self).run(*args, **kwargs)
        finally:
    ...
    def _makeResult(self):
        result = super(NoDbDjangoTestRunner, self)._makeResult()
...
class NoDbDjangoTestSuiteRunner(object):
    ...
    def run_suite(self, suite, **kwargs):
        return NoDbDjangoTestRunner(verbosity=self.verbosity, failfast=self.failfast).run(suite)
...
def run_tests(test_labels, verbosity=1, interactive=True, failfast=False, extra_tests=None):
    ...
    test_runner = NoDbDjangoTestSuiteRunner(verbosity=verbosity, interactive=interactive, failfast=failfast)
